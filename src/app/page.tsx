...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/blonde-woman-sitting-cafe_273609-5102.jpg",
          alt: "Diner 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/stylish-friends-sitting-cafe_273609-5476.jpg",
          alt: "Diner 2",
        },
        {
          src: "http://img.b2bpic.net/free-photo/medium-shot-happy-family-with-kid_23-2149001349.jpg",
          alt: "Diner 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/medium-shot-friends-chatting-indoors_23-2149116778.jpg",
          alt: "Diner 4",
        },
        {
          src: "http://img.b2bpic.net/free-photo/close-up-smiley-people-table_23-2149001328.jpg",
          alt: "Diner 5",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "Frutos do mar selecionados diariamente da nossa costa.",
          icon: Fish,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Conforto total com vista para o mar em Inhambane.",
          icon: Sun,
          mediaItems: [
            {
        ...
        },
        {
          ...
          description: "Equipe treinada para garantir uma experiência premium.",
          icon: Award,
          mediaItems: [
            {
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          rating: 5,
          reviewCount: "150",
          imageSrc: "http://img.b2bpic.net/free-photo/flat-lay-food-frame-mediterranean-diet-with-mussels_23-2148234943.jpg",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Maria Silva",
          role: "Turista",
          testimonial: "Melhor caranguejo da costa. O ambiente é maravilhoso!",
          imageSrc: "http://img.b2bpic.net/free-photo/young-adult-having-fun-white-party_23-2149575126.jpg",
        },
        {
          id: "t2",
          name: "João Pereira",
          role: "Cliente local",
          testimonial: "Excelente atendimento e comida sempre fresca.",
          imageSrc: "http://img.b2bpic.net/free-photo/medium-shot-adults-kid-outside_23-2149001321.jpg",
        },
        {
          id: "t3",
          name: "Ana Souza",
          role: "Visitante",
          testimonial: "Um lugar que sempre retorno. Atmosfera perfeita.",
        ...
        },
        {
          ...
          name: "Carlos M.",
          role: "Turista",
          testimonial: "O serviço é rápido e o peixe é incrível.",
          imageSrc: "http://img.b2bpic.net/free-photo/brazilian-woman-having-guarana-drink-outdoors_23-2150765642.jpg",
        },
        {
          id: "t5",
          name: "Luísa Ferreira",
          role: "Cliente fiel",
          testimonial: "Telvina é sinônimo de qualidade e hospitalidade.",
          imageSrc: "http://img.b2bpic.net/free-photo/cheerful-couple-playing-beach_1153-813.jpg",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Abrimos diariamente das 08:00 às 22:00.",
        },
        {
          id: "f2",
          title: "Como reservar?",
          content: "Pode ligar ou enviar uma mensagem via WhatsApp.",
        },
        {
          id: "f3",
          title: "Aceitam cartões?",
          content: "Sim, aceitamos cartões de débito e crédito locais.",
        },
        {
          id: "f4",
          title: "Onde estamos?",
          content: "Localizados na praia de Inhambane.",
        },
      ]}
